...
class MethodModel(private val executableElement: ExecutableElement) {

    val methodName: String by lazy {
        executableElement.simpleName.toString()
    }

    val methodResultType: Type by lazy {
        executableElement.returnType.toType()
    }

    val isId: Boolean by lazy {
        val anns = processingEnvironment!!.elementUtils.getAllAnnotationMirrors(executableElement)
        anns.firstOrNull {
